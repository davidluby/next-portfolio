...
export default function Home() {
    ...
    return (
        <div className="flex flex-col items-center mb-20">
                <h1 className="w-[97%] res:w-5/6 mt-10 border-b-4 border-yellow-500 text-center res:text-left">Welcome</h1>
                ...
                <h1 className="w-[97%] res:w-5/6 mt-20 border-b-4 border-yellow-500 text-center res:text-left">Simulations</h1>
                <div className="flex flex-col items-center res:flex-row justify-between w-[97%] res:w-5/6">
                    <Projectile name="projectile"/>
                    <ThreeProjectile />
                </div>
                <Fluids />
                <h1 className="w-[97%] res:w-5/6 mt-20 border-b-4 border-yellow-500 text-center res:text-left">Mechatronic Conveyor</h1>
                ...
                <h1 className="w-[97%] res:w-5/6 mt-20 mb-5 border-b-4 border-yellow-500 text-center res:text-left">Fullstack Application</h1>
                <App />
