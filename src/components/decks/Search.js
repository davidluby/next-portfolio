...
export default function Search({ setPlayerData, setSearching, setHidden }) {
    ...
    return (
        <div className="flex flex-col items-center w-1/2 relative">
            ...
            <input className="w-full py-2 px-10 border-2 border-gray-300 shadow-md rounded-full transition all duration-500 hover:border-[#BA9653] focus:outline-none focus:border-yellow-500"
                placeholder="Search"
