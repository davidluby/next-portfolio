        ...
        <div className="w-full res:w-[49%] my-5 res:mb-0  tile bg-slate-900">
            ...
            <div className="flex flex-col">
                ...
                <div className="flex flex-row items-center justify-center space-x-2">
                    <button className="rounded-md p-1 bg-slate-800 hover:bg-slate-700 text-sm text-white" onClick={() => restart()}>Restart</button>
                    <button className="rounded-md p-1 bg-slate-800 hover:bg-slate-700 text-sm text-white" onClick={() => toggleGravity()}>Toggle Gravity</button>
                    <div className="flex flex-col items-center">
                        <p className="text-sm">Elasticity</p>
